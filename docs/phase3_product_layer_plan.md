...
> **API progress:** FastAPI scaffolding plus `/health` and initial `/cohorts` listing endpoints now exist; continue layering auth, cohort CRUD, and stats reads atop this foundation.
